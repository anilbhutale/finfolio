...
import { setCredentials, setUser } from '../features/authenticate/authSlice';
...
const Login = () => {
  ...
  const validationSchema = object({
    username: string()
      ...
      .min(4, 'Username must be atleast 6 characters long.'),
    password: string()
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      dispatch(updateLoader(60));
      const res1 = await user().unwrap();
      await dispatch(setUser(res1));
